...
In today’s lab, we will work with fine need aspiration (FNA) of breast
...
Before analysis, I want to remove the expert diagnoses column (aka the
...
We can clearly see 2 clusters and can probably even draw a line to
separate B and M.
...
We can use our PCA result (model) to do predictions, i.e., taking new
unseen data and projecting it onto our new PC variables.
...
The hierarchical clustering of PCA resulted in the best sensitivity and
specificity. The model with the best sensitivity should have the highest
TP/(TP+FN). The model with the best sensitivity should have the highest
TN/(TN+FN).

> Q18. Which of these new patients should we prioritize for follow up
> based on your results?

We should prioritize a follow up for patient 2 because their diagnosis
was malignant.
